...
import type { Milestone, Project, ProjectDoc, ProjectStatus } from '@/types';
...
// Chat lives in its own model (see conversations.ts), not nested here.
